...
<head>
    ...
    <title>HHV Thermal Tech - Premier Thermal Vacuum Technology Group</title>
...
<body>
            ...
            <div class="swiper-slide hero-carousel-slide">
                ...
                <div class="hero-carousel-slide-info">
                    <div class="hero-carousel-text-onebyone">
                        ...
                        <h2>Precision in Every Process</h2>
                        <p>Advanced heat treatment & brazing under vacuum.<br class="hero-carousel-slide-break">Reliable performance for critical applications.</p>
            ...
            <div class="swiper-slide hero-carousel-slide">
                ...
                <div class="hero-carousel-slide-info">
                    <div class="hero-carousel-text-onebyone">
                        ...
                        <h2>Furnaces Built for You</h2>
                        <p>Tailored vacuum systems for diverse industries.<br class="hero-carousel-slide-break">Designed for efficiency and long life.</p>
            ...
            <div class="swiper-slide hero-carousel-slide">
                ...
                <div class="hero-carousel-slide-info">
                    <div class="hero-carousel-text-onebyone">
                        ...
                        <p>Expert care with genuine spares.<br class="hero-carousel-slide-break">Ensuring smooth, uninterrupted operations.</p>
                        <a href="#">Learn More&nbsp;&nbsp;></a>
                    </div>
                </div>
            </div>
            <div class="swiper-slide hero-carousel-slide">
                ...
                <div class="hero-carousel-slide-info">
                    <div class="hero-carousel-text-onebyone">
                        ...
                        <h2>Spares You Can Trust</h2>
                        <p>Ensure uninterrupted operations with our expert spares,<br class="hero-carousel-slide-break">servicing, and maintenance support.</p>
    ...
    <div class="where-do-we-need-ation">
        <div>
            <h4>Thermal Technologies</h4>
            <h2>Where do our systems excel?</h2>
            <div class="where-do-we-need-ation-cards">
                <a href="#" class="where-do-we-need-ation-card">
                    ...
                    <div class="where-do-we-need-ation-card-title">
                        <!-- <h3>Heat Treatment<span class="arrow"><i class="fa-solid fa-arrow-right"></i></span></h3> -->
                ...
                <a href="#" class="where-do-we-need-ation-card">
                    ...
                    <div class="where-do-we-need-ation-card-title">
                        <!-- <h3>Vacuum Brazing<span class="arrow"><i class="fa-solid fa-arrow-right"></i></span></h3> -->
                        <h3>Vacuum Brazing</h3>
                    </div>
                </a>
                <a href="#" class="where-do-we-need-ation-card">
                    ...
                    <div class="where-do-we-need-ation-card-title">
                        <!-- <h3>Sintering<span class="arrow"><i class="fa-solid fa-arrow-right"></i></span></h3> -->
                        <h3>Sintering</h3>
                    </div>
                </a>
                <a href="#" class="where-do-we-need-ation-card">
                    ...
                    <div class="where-do-we-need-ation-card-title">
                        <!-- <h3>Hot Press<span class="arrow"><i class="fa-solid fa-arrow-right"></i></span></h3> -->
                        <h3>Hot Press</h3>
                    </div>
                </a>
                <a href="#" class="where-do-we-need-ation-card">
                    ...
                    <div class="where-do-we-need-ation-card-title">
                        <!-- <h3>Thermo-Vacuum<span class="arrow"><i class="fa-solid fa-arrow-right"></i></span></h3> -->
                        <h3>Thermo-Vacuum</h3>
                    </div>
                </a>
                <a href="#" class="where-do-we-need-ation-card">
                    ...
                    <div class="where-do-we-need-ation-card-title">
                        <!-- <h3>Diffusion Bonding<span class="arrow"><i class="fa-solid fa-arrow-right"></i></span></h3> -->
                        <h3>Difusion Bonding</h3>
                    </div>
                </a>
                <a href="#" class="where-do-we-need-ation-card">
                    ...
                    <div class="where-do-we-need-ation-card-title">
                        <!-- <h3>Crystal Growth<span class="arrow"><i class="fa-solid fa-arrow-right"></i></span></h3> -->
                ...
                <a href="#" class="where-do-we-need-ation-card">
                    ...
                    <div class="where-do-we-need-ation-card-title">
                        <!-- <h3>Thin Films<span class="arrow"><i class="fa-solid fa-arrow-right"></i></span></h3> -->
                        <h3>Thin Films</h3>
                    </div>
                </a>
                <a href="#" class="where-do-we-need-ation-card">
                    ...
                    <div class="where-do-we-need-ation-card-title">
                        <!-- <h3>Metallurgy<span class="arrow"><i class="fa-solid fa-arrow-right"></i></span></h3> -->
                        <h3>Metallurgy</h3>
                    </div>
                </a>
                <a href="#" class="where-do-we-need-ation-card">
                    ...
                    <div class="where-do-we-need-ation-card-title">
                        <!-- <h3>Aerospace<span class="arrow"><i class="fa-solid fa-arrow-right"></i></span></h3> -->
                        <h3>Aerospace</h3>
                    </div>
                </a>
            </div>
