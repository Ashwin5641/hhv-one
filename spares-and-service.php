...
<head>
    ...
    <title>Spares and Services | HHV Thermal Technologies</title>
    <link rel="icon" href="./assets/images/favicon.png" type="x-image/icon">

    <!-- --------------link for the styling service page--------------- -->
    <link rel="stylesheet" href="./style.css">
    <link rel="stylesheet" href="./spares-and-service.css">
...
<body>
    ...
    <div class="page-title-section">
        <div class="page-title">
            <h4>PRODUCTS</h4>
            <h2>Spares and Services</h2>
            <div class="page-title-nav">
                <a href="./index.php">Home</a>
                <span><i class="fa-solid fa-angle-right"></i></span>
                <a href="#">Products</a>
                <span><i class="fa-solid fa-angle-right"></i></span>
                <a href="#">Spares and Services</a>
            </div>
        </div>
    </div>
